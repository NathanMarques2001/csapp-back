...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_grupos_economicos_status";');
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_clientes_tipo_unidade";');
  }
};
