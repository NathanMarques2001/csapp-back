...
module.exports = {
  async login(req, res) {
    try {
      ...
      if (usuario.microsoft_oid && !usuario.senha) {
        ...
        return res.status(403).send({
          message:
            'Esta conta deve ser acessada através do botão "Entrar com Microsoft".',
        });
      }
      ...
      return res
        .status(500)
        .send({ message: "Ocorreu um erro interno ao tentar fazer login." });
    }
  },
  ...
  async index(req, res) {
    try {
      ...
      return res
        .status(500)
        .send({ message: "Ocorreu um erro ao buscar o usuário." });
    }
  },
  ...
  async indexAll(req, res) {
    try {
      ...
      return res
        .status(500)
        .send({ message: "Ocorreu um erro ao buscar os usuários." });
    }
  },
  ...
  async delete(req, res) {
    try {
      ...
      return res
        .status(500)
        .send({ message: "Ocorreu um erro ao deletar o usuário." });
    }
  },
};
